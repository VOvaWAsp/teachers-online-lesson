...
function Favorites({ catalogs, isOpened }) {
  ...
  return (<>
   {favoriteItems.length === 0 ? (
    <h2>Here your favorite teachers</h2>
    ) : (
        <>
              ...
              <div className={css.blockCard}>
                ...
                <div>
                  ...
                  <p className={css.text}>
                    ...
                    {item.languages.map((language) => (
                      <span className={css.subtitleWithLine}> {language}</span>
                    ))}
                  </p>
                ...
                <div className={css.containerLevel}>
                      {item.levels.map((item) => {
                        return ( <div className={css.blockLevel}>
